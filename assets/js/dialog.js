...
const dialogs = [
  ...
  {
    name: "Rascal",
    text: "Ga ada ekspektasi bakal sejauh ini. Bahkan ga pernah kepikiran kalau itu justru jadi awal perjalanan kita.",
  },
  {
    name: "Rascal",
    text: "Padahal waktu itu, ekpektasiku hanya menemani dia menghibur diri, lalu pergi",
  },
  {
    name: "Octavia",
    text: "...",
...
function selectCharacter(character) {
  if (character === "Rascal") {
    ...
    gameBody.classList.add("bg-active");
    bgm.volume = 0.6;
    bgm.loop = true;
    bgm.play();
    ...
    setTimeout(() => {
      gameBody.classList.remove("bg-active");
...
function displayDialog(index) {
  if (index < dialogs.length) {
    ...
    if (dialog.name === "Octavia") {
      ...
      characterImageElement.src = "assets/img/character/Octavia/Neutral.png";
...
const lyricsData = {
  lyrics: [
    { text: "Sasa, malam ini mau pergi ke mana?", time: 8 },
    { text: "Masih bisakah kau dan teman-temanmu rayakan dunia?", time: 15 },
    { text: "Tengah malam ini 'kan bertemu siapa?", time: 23 },
    { text: "Bisakah Ia tersenyum menyikapi dunia?", time: 30 },
    { text: "Maukah kalian memaafkan kami semua?", time: 39 },
    { text: "Kami rampas berbagai hal yang bisa buatmu bahagia", time: 47 },
    { text: "Jalanmu berat, seumur hidup", time: 56 },
    { text: "Semoga ada bara yang tersisa", time: 64 },
    { text: "Pun kata maaf, jauh terlambat datang", time: 72 },
    { text: "Salahkan kami", time: 85 },
    { text: "Jika suatu saat kau jadi Ibu juga", time: 88 },
    { text: "Paman harap kau ajarkan Ia tuk merayakan dunia", time: 93 },
    { text: "Semoga Ia tak ulangi lalai kami semua", time: 103 },
    { text: "Bisakah tak kau rampas api itu dari dalam dirinya?", time: 110 },
    { text: "Jalanmu berat, seumur hidup", time: 120 },
    { text: "Semoga ada bara yang tersisa", time: 130 },
    { text: "Pun kata maaf, jauh terlambat datang", time: 138 },
    { text: "Salahkan kami", time: 150 },
    { text: "Salahkan kami, kami mengerti", time: 155 },
    {
      text: "Satu hal yang bisa kau tiru hanya perihal merusak diri",
      time: 162,
    },
    { text: "Berharap hal baik yang kau temui hari ini berarti", time: 170 },
    { text: "Saat kau dewasa nanti", time: 178 },
    { text: "Jalanmu berat, seumur hidup", time: 188 },
    { text: "Semoga ada bara yang tersisa", time: 197 },
    { text: "Pun kata maaf, jauh terlambat datang", time: 205 },
    { text: "Salahkan kami", time: 216 },
    { text: "Jalanmu berat, seumur hidup", time: 221 },
    { text: "Semoga ada bara yang tersisa", time: 229 },
    { text: "Pun kata maaf, jauh terlambat datang", time: 237 },
    { text: "Salahkan kami", time: 250 },
    { text: "Alexandra by Hindia", time: 256 },
  ],
};
...
//     if (currentDialogIndex === 6) {
//       // First question "cinta"
//       correctAnswer = "cinta";
//     } else if (currentDialogIndex === 11) {
//       // Second question "kepercayaan"
//       correctAnswer = "kepercayaan";
//     } else if (currentDialogIndex === 16) {
//       // Third question "harapan"
//       correctAnswer = "harapan";
//     }
