...
const targetDate = new Date("October 07, 2025 00:00:00").getTime();
...
const countdownInterval = setInterval(() => {
  ...
  if (timeDifference < 0) {
    ...
    messageParagraph.textContent =
      "Walaupun aku bukan orang yang romantis, tapi ini aku coba kasih yang terbaik buat kamu. Semoga kamu suka ya.";
